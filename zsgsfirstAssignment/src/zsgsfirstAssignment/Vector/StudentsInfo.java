package zsgsfirstAssignment.Vector;
...
public class StudentsInfo {
	...
	static Vector<StudentsDetailPojo> studentsDataBase=new Vector<StudentsDetailPojo>();
    static	Vector<StudentsDetailPojo> studentsDataBasecopy;
	static Vector<StudentsDetailPojo> studentsDataBaseclone=new Vector<StudentsDetailPojo>();
  ...
  StudentsInfo.main(null);	
	...
	private void Empty() 
	{
		System.out.println(" delete (Empty) on studentList..!! ");
	...
	private void cloneAnArrayList() {
		...
		studentsDataBaseclone= (Vector<StudentsDetailPojo>) studentsDataBase.clone();
	...
	public static void main(String[] args) {
		...
		case "16":{
			studentsinfoObj.checkEmptyOrNot();
			break;
		}
		case "17":{
