...
public class StudentsInfo {
	...
	static LinkedList<StudentsDetailPojo> studentsDataBase=new LinkedList<StudentsDetailPojo>();
    static	LinkedList<StudentsDetailPojo> studentsDataBasecopy;
	static LinkedList<StudentsDetailPojo> studentsDataBaseclone=new LinkedList<StudentsDetailPojo>();
...
private void Empty() 
{
	...
	private void cloneAnArrayList() {
		...
		studentsDataBaseclone=(LinkedList<StudentsDetailPojo>) studentsDataBase.clone();
